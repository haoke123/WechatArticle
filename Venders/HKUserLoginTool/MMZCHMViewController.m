...
//    
   self.title=@"注册1/3";
    ...
    [self.navigationItem setTitleView:[HKUITool createTitleViewWithTitle:@"注册1/3"]];
...
-(void)createTextFields
{
    ...
    codeConfirm = [self createTextFielfFrame:CGRectMake(100, 110, 90, 30) font:[UIFont systemFontOfSize:14] placeholder:@"确认密码"];
    
    codeConfirm.clearButtonMode = UITextFieldViewModeWhileEditing;
    //code.text=@"mojun1992225";
    //密文样式
    codeConfirm.secureTextEntry=YES;
    codeConfirm.keyboardType=UIKeyboardTypeNumberPad;
