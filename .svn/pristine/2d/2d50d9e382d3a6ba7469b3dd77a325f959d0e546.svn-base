...
static CGFloat const JTSImageViewController_TransitionAnimationDuration = 0.5f;
        ...
        NSURLSessionDataTask *task = [JTSSimpleImageDownloader downloadImageForURL:imageInfo.imageURL canonicalURL:imageInfo.canonicalImageURL completion:^(UIImage *image) {
            ...
            if (image) {
                if (strongSelf.isViewLoaded) {
                    ...
                    [strongSelf updateInterfaceWithImage:[UIImage sd_animatedGIFWithData:UIImagePNGRepresentation(image) ]];
